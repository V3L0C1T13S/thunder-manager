...
const titleName = "Thunder Manager";
...
function ResponsiveAppBar() {
    ...
    const onNavigationButtonClicked = (url: string) => {
        handleCloseNavMenu();
        navigate(url);
    }
            ...
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                        ...
                        >
                            {pages.map((page) => (
                                <MenuItem key={page.name} onClick={() => onNavigationButtonClicked(page.url)}>
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
                        {pages.map((page) => (
                            <Button
                                key={page.name}
                                onClick={() => onNavigationButtonClicked(page.url)}
